    ...
    <div class="mt-8 bg-white p-6 rounded shadow">
        ...
        <div class="flex gap-4">
            <a href="{{ route('admin.news.create') }}"
                class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Write News</a>
            <a href="{{ route('admin.faq.create') }}"
                class="bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-700">Add FAQ Question</a>
        </div>
    </div>
</x-admin-layout>