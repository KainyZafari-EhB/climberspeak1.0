            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST">
                ...
                <div class="mb-6">
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="is_admin" class="form-checkbox h-5 w-5 text-blue-600" value="1" {{ old('is_admin', $user->is_admin) ? 'checked' : '' }}>
                        <span class="ml-2 text-gray-700 font-bold">Grant Admin Privileges</span>
                    </label>
                </div>
