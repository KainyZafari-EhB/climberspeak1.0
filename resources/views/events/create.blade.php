<x-layout>
    <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-8 my-8">
        <header class="mb-8 border-b pb-4">
            ...
            <p class="text-gray-600 mt-2">Fill out the form to add a new climbing event.</p>
        </header>
        ...
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex items-center justify-end pt-6 border-t gap-4">
                <a href="{{ route('events.index') }}" class="text-gray-600 hover:text-gray-900 font-medium">
                    Cancel
                </a>
                <button type="submit"
                    class="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 shadow-md transition font-semibold">
                    Create Event
                </button>
            </div>
        </form>
